...
var testdata2 = "wqeewq wqeweqwe wqweqew wqwweqwq qweeqwew qww qweqweqqw qweew";
  ...
  if (!testing) {
    testing = true;
     interval = setInterval(function(){ 
        var start = Date.now();
        var msg = {action : "ping", id:otherId, start:start, testdata:testdata2};
